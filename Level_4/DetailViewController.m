...
@property (weak, nonatomic) IBOutlet UIButton *btnCartShow;
...
- (IBAction)btnAddToCart:(id)sender {
    ...
    [sharedInstance.cartArray addObject:detailsList];
    NSString *string = [NSString stringWithFormat:@"%lu",(unsigned long)[sharedInstance.cartArray count]];
    [_btnCartShow setTitle:string forState:UIControlStateNormal];
}
@end
